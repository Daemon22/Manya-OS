/**
 * @manya-os/customs-shield — shared type definitions.
 *
...
export interface ShieldFinding {
    /** Category of finding. */
    category: 'hs_code_invalid' | 'hs_code_mismatch' | 'hs_code_suggestion' | 'sanctions_hit' | 'sanctions_country_hit' | 'restriction_violation' | 'license_required' | 'duty_miscalculation' | 'documentation_gap' | 'vulnerability' | 'risk_indicator';
    severity: Severity;
