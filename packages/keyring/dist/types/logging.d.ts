/**
 * @manya-os/keyring — structured logging with secret scrubbing.
 *
 ...
 * case-insensitive and matches by suffix, so `userPassword` is scrubbed
 * alongside `password`.
 */
export declare const SCRUBBED_FIELD_NAMES: readonly ["privateKey", "password", "passphrase", "token", "secret", "credential", "iv", "tag", "share"];
/**
