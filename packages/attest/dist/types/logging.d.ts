/**
 * @manya-os/attest — structured logging with secret scrubbing.
 *
 ...
 * alongside `token`.
 */
export declare const SCRUBBED_FIELD_NAMES: readonly ["privateKey", "password", "passphrase", "token", "secret", "credential", "iv", "tag", "share", "nonce", "signature", "macs", "machineId"];
/**
